...
from PyPRPImport import alcconfig
alcconfig.startup()

import Blender, time, sys, os
from os.path import *
from PyPRPImport.alcresmanager import *
from PyPRPImport.alcurutypes import *
from PyPRPImport.alc_AlcScript import *
...
def do_main():
    ...
    #    fname = "Import . " + w[1]
    fname = "Import . " + w[1]
    if w[-1] == "tex": # hack but I don't feel like handling an exception for this.
        alcconfig.extractAllTextures = True
